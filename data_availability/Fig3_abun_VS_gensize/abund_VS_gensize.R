#########################
#Figure 3 TE abundance vs genome size
###########################
...
#plot tree
#import tree
tree <- read.newick('../Nuclear_tree/raxml_radtree_edit.tre') #Load Corydoras newick trees
...
#http://blog.phytools.org/2012/11/fitting-model-in-phylogenetic.html -useful!
